...
object ScalaRecap extends App {
  ...
  future.onComplete {
    ...
    case Failure(exc) =>  println(s"still don't know meaning of life... $exc")
  }
  ...
  List(1,2,3).sorted // numberOrdering as second arg == List(3,2,1)
  ...
  List(Person("Bob"),Person("Alice"),Person("Charlie"))
